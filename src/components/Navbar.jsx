    ...
    <header className="w-full z-50 relative">
      <nav className="container mx-auto px-4 py-4 sm:py-6 flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm">
          ...
          <Link href="/weather-map" className="hover:text-indigo-400 transition-colors">Weather Map</Link>
        ...
        >
          ...
          <Link href="/weather-map" onClick={() => setIsOpen(false)} className="hover:text-indigo-400 transition-colors text-lg">Weather Map</Link>
